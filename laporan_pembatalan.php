...
WHERE
    pb.kategori IN ('Keperluan Ekonomi', 'Meninggal Dunia')
...
<body>
            ...
            <main class="pPembatalan-wrapper">
                <div class="pPembatalan">
                    <div class="pPembatalan-header" style="color: white;">
                        <i class="fas fa-table me-1"></i> Laporan Pembatalan Jamaah Haji
                    </div>
                            ...
                            <table id="tabelStaf" class="table table-striped table-bordered table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th class="text-center">Status Pembatalan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
    ...
    <!-- Custom Scripts -->
    <script src="tanggal_cetak_pembatalan.js"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // PERBAIKAN: Gunakan ID yang benar sesuai dengan HTML
            const cetakLaporanBtn = document.getElementById('print-report-btn'); // Ganti dari 'cetak-laporan-btn' ke 'print-report-btn'
            ...
            if (cetakLaporanBtn) {
                cetakLaporanBtn.addEventListener('click', function() {
                    ...
                    const printUrl = `cetak_laporan_pembatalan.php?start_date=${startDate}&end_date=${endDate}`;
