...
<!DOCTYPE html>
<html lang="id_pembatalan">

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Edit Pembatalan Jamaah Meninggal Dunia</title>
...
<body>
            ...
            <main class="pPembatalan-wrapper">
                <div class="pPembatalan">
                    <div class="pPembatalan-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-edit me-1"></i> Edit Pembatalan Haji - Meninggal Dunia
                    </div>
                    <div class="pPembatalan-body" style="color: #1b5e20;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <!-- ================================================================================================= -->
                            <div class="section-title">Edit Berkas Pembatalan - Meninggal Dunia</div>
                            <hr>
                            <div class="row g-3">
                                <!-- Akta Kematian -->
                                <div class="col-md-4">
                            ...
                            <div class="action-buttons">
                                <button type="submit" class="btn btn-success">EDIT PEMBATALAN</button>
                                <a href="pembatalan_jamaah_meninggal.php" class="btn btn-secondary">BATAL</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script src="tambah_data.js"></script>
