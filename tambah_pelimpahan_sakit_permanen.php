...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dokumen_surat_sakit = uploadFile('dokumen_surat_sakit', 'surat_sakit');
    ...
    $stmt_pelimpahan = $koneksi->prepare("INSERT INTO pelimpahan (id_jamaah, kategori, tanggal_pengajuan) VALUES (?, 'Sakit Permanen', NOW())");
    ...
    if ($stmt_pelimpahan->execute()) {
        ...
        $stmt_insert = $koneksi->prepare("INSERT INTO pelimpahan_sakit (
        id_pelimpahan,
        ...
        kode_pos_ahliwaris, dokumen_surat_sakit, dokumen_setor_awal, dokumen_spph, dokumen_ahli_waris,
        ...
        if ($stmt_insert->execute()) {
            ...
            updateAktivitasPengguna($id_jamaah, 'jamaah', 'Pelimpahan', 'Menambahkan data pelimpahan sakit permanen');
            $_SESSION['success_message'] = "Data pelimpahan berhasil ditambahkan.";
            header("Location: pelimpahan_jamaah_sakit.php");
            exit();
        } else {
            $_SESSION['error_message'] = "Gagal menambahkan data pelimpahan sakit: " . $stmt_insert->error;
        }
            ...
            <main class="pPelimpahan-wrapper">
                <div class="pPelimpahan">
                    <div class="pPelimpahan-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-plus me-1"></i> Tambah Pelimpahan Haji - Sakit Permanen
                    </div>
                    <div class="pPelimpahan-body" style="color: #1b5e20;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <!-- ================================================================================================= -->
                            <div class="section-title">Upload Berkas Pelimpahan - Sakit Permanen</div>
                            <hr>
                            <div class="row g-3">
                                <!-- Surat Keterangan Sakit -->
                                <div class="col-md-4">
                                    <label class="form-label">Surat Keterangan Sakit (PDF)</label>
                                    <input type="file" name="dokumen_surat_sakit" class="form-control" accept="application/pdf" required>
                                </div>
                            ...
                            <div class="action-buttons">
                                <button type="submit" class="btn btn-success">TAMBAH PELIMPAHAN</button>
                                <a href="tambah_pelimpahan.php" class="btn btn-secondary">BATAL</a>
                            </div>
                        </form>
