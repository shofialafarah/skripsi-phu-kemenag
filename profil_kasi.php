...
<head>
    ...
    <title>Profil Kepala Seksi - PHU KEMENAG</title>
    <link rel="icon" href="logo_kemenag.png">
    <style>
        :root {
            ...
            <div class="profile-content">
                <div class="profile-image">
                    ...
                    <div style="margin-top: 10px; text-align: center;">
                        <img src="<?php echo $qr_img; ?>" alt="QR Code Profil Kasi" style="width: 80px; height: 80px;">
                ...
                <div class="profile-details">
                    <div class="info-row">
                        <div class="info-group">
                            ...
                            <div class="info-value"><?php echo htmlspecialchars($kasi['nama_kepala']); ?></div>
                        </div>

                        <div class="info-group">
                            <div class="info-label">NIP</div>
                            <div class="info-value"><?php echo htmlspecialchars($kasi['nip']); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        <div class="info-group">
                            ...
                            <div class="info-value"><?php echo htmlspecialchars($kasi['pangkat']); ?></div>
                        </div>

                        <div class="info-group">
                            <div class="info-label">Jabatan</div>
                            <div class="info-value"><?php echo htmlspecialchars($kasi['jabatan']); ?></div>
                        </div>
                    </div>

                    <div class="info-group">
                        <div class="info-label">Pendidikan Terakhir</div>
                        <div class="info-value"><?php echo htmlspecialchars($kasi['pend_terakhir']); ?></div>
                    </div>

                    <div class="info-group">
                        <div class="info-label">Tempat dan Tanggal Lahir</div>
                        <div class="info-value"><?php echo htmlspecialchars($kasi['tempat_lahir']); ?>, <?php echo formatTanggalIndonesia($kasi['tgl_lahir']); ?></div>
                    </div>
                    ...
                    <div class="contact-info">
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-value"><?php echo htmlspecialchars($kasi['alamat']); ?></div>
                        </div>

                        <div class="info-group">
                            <div class="info-label">Email</div>
                            <div class="info-value"><?php echo htmlspecialchars($kasi['email']); ?></div>
                        </div>

                        <div class="info-group">
                            <div class="info-label">Username</div>
                            <div class="info-value"><?php echo htmlspecialchars($kasi['username']); ?></div>
                        </div>

                        <div class="info-group">
                            <div class="info-label">Nomor Telepon</div>
                            <div class="info-value"><?php echo htmlspecialchars($kasi['no_telepon']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
