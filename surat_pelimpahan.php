...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT *, 'Sakit Permanen' AS kategori FROM pelimpahan_sakit WHERE id_limpah_sakit = ?
    UNION SELECT *, 'Meninggal Dunia' AS kategori FROM pelimpahan_meninggal WHERE id_limpah_meninggal = ? LIMIT 1";
