...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert data ke tabel pelimpahan_meninggal
    $query_pelimpahan = "
        INSERT INTO pelimpahan_meninggal (
            nama_ahli_waris, nama_ayah, tempat_lahir, tanggal_lahir, alamat, kecamatan, kelurahan, provinsi,
            jenis_kelamin, pekerjaan, no_telepon, status_dengan_jamaah, nama_jamaah, bin_binti, tempat_lahir_jamaah, tanggal_lahir_jamaah, alamat_jamaah,
            ...
            nominal_setoran, no_rekening_ahli_waris, bank_ahli_waris, nama_kuasa_waris, tahun_wafat, tanggal_wafat
        )
        VALUES (
            '$nama_ahli_waris', '$nama_ayah', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$kecamatan', '$kelurahan', '$provinsi',
            '$jenis_kelamin', '$pekerjaan', '$no_telepon', '$status_dengan_jamaah', '$nama_jamaah', '$bin_binti', '$tempat_lahir_jamaah', '$tanggal_lahir_jamaah', '$alamat_jamaah',
...
<body>
    <div class="background-atas">
        <div class="header">
            <h1>Tambah Pelimpahan - Meninggal Dunia</h1>
        ...
        <form action="tambah_pelimpahan_meninggal.php" method="POST">
            <P>DATA AHLI WARIS</P>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="status_dengan_jamaah" id="status_dengan_jamaah" class="form-control" required>
