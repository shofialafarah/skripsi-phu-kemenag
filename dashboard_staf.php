...
<body>
    <div class="layout">
        ...
        <div class="layout-content">
            ...
            <main class="dashboardStaf-wrapper">
                <div class="staf-grid">

                    <!-- Stats Cards - Jamaah Belum Divalidasi & Jamaah Sudah Divalidasi -->
                        ...
                        <table class="dokumen-table">
                            ...
                            <tbody>
                                ...
                                foreach ($statusDokumen as $dokumen):
                                    // Cek dokumen yang perlu verifikasi (status NULL)
                                    $perluVerifikasi = [];
                                    $dokumenMapping = [
                                    ...
                                    // Tampilkan hanya jika ada dokumen yang perlu verifikasi
