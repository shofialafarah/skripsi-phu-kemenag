...
$result = $koneksi->query("SELECT * FROM pelimpahan_meninggal WHERE id_pelimpahan = $id_pelimpahan AND id_pelimpahan IN (SELECT id_pelimpahan FROM pelimpahan WHERE id_jamaah = $id_jamaah)");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update query
    $stmt = $koneksi->prepare("UPDATE pelimpahan_meninggal SET 
    ...
    if ($stmt->execute()) {
        ...
        updateAktivitasPengguna($id_jamaah, 'jamaah', 'Pelimpahan', 'Mengedit data pelimpahan meninggal dunia');
            ...
            <main class="pPembatalan-wrapper">
                <div class="pPembatalan">
                    <div class="pPembatalan-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-edit me-1"></i> Edit Pelimpahan Haji - Meninggal Dunia
                    </div>
                    <div class="pPembatalan-body" style="color: #1b5e20;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <!-- ================================================================================================= -->
                            <div class="section-title">Edit Berkas Pelimpahan - Meninggal Dunia</div>
                            <hr>
                            <div class="row g-3">
                                <!-- Akta Kematian -->
                                <div class="col-md-4">
                            ...
                            <div class="action-buttons">
                                ...
                                <a href="pelimpahan_jamaah_meninggal.php" class="btn btn-secondary">BATAL</a>
                            </div>
                        </form>
                    </div>
