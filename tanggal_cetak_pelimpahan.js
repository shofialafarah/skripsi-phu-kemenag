...
$(document).ready(function () {
  ...
  const TGL_COL = 6; // kolom tanggal verifikasi
  ...
  // ===========================================
  // TAMBAHKAN KODE INI UNTUK TOMBOL CETAK LAPORAN
  // ===========================================
  const filterStartInput = document.getElementById("filter-start");
  const filterEndInput = document.getElementById("filter-end");
  const cetakLaporanBtn = document.getElementById("print-report-btn"); // **PASTIKAN ID SUDAH BENAR SESUAI HTML ANDA**
  ...
  if (cetakLaporanBtn) {
    cetakLaporanBtn.addEventListener("click", function () {
      ...
      if (!startDate || !endDate) {
        alert(
          "Mohon lengkapi Tanggal Mulai dan Tanggal Akhir untuk mencetak laporan."
        );
        return;
      }
