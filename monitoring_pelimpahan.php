...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        // Ambil detail dokumen berdasarkan kategori
        ...
        if ($detail_result->num_rows > 0) {
            ...
            // Gabungkan data detail ke dalam row
            $row = array_merge($row, $detail_data);
        }
        $stmt->close();

        // Set nama pengaju jika kosong
...
// PERBAIKAN: Struktur dokumen yang lebih konsisten
$doc_fields = [
    'Meninggal Dunia' => [
...
// PERBAIKAN: Fungsi untuk mengecek apakah semua dokumen sudah terverifikasi
...
// PERBAIKAN: Update fungsi updateValidationDateIfAllVerified
