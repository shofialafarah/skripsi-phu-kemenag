...
<head>
    ...
    <title>Surat Permohonan Pelimpahan</title>
...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Perihal</td>
            <td>: Mohon Pelimpahan Nomor Porsi <br>Jemaah Haji Yang <?php echo $data['kategori']; ?></td>
        </tr>
    </table>
    <div class="content">
        <p>
        ...
        <table>
            ...
            <tr>
                <td>Alamat</td>
                <td>: <?php echo $data['alamat_jamaah'] . ', Kec. ' . $data['kecamatan_jamaah'] . ', Kel. ' . $data['kelurahan_jamaah'] . ', ' . $data['kode_pos_jamaah'] . ', Kab. Banjar'; ?></td>
            </tr>
            <tr>
                <td>Provinsi</td>
                <td>: Kalimantan Selatan </td>
