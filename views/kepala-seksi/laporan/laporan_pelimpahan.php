...
-- Join ke tabel jamaah melalui id_jamaah dari tabel pelimpahan
LEFT JOIN jamaah j 
...
<div class="layout">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($data_pelimpahan)) {
                                        foreach ($data_pelimpahan as $row) {
                                            ...
                                            echo "<td class='text-center'> <a href='$link_wa' target='_blank' class='text-decoration-none'>
    ...
    <script src="/phu-kemenag-banjar-copy/views/kepala-seksi/laporan/assets/js/filterTanggal_pelimpahan.js"></script>
    <script src="assets/js/cetakPelimpahan.js"></script>
</body>
