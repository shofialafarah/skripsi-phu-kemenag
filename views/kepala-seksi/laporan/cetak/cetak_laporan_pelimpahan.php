        ...
        <table class="tabel-cetak">
            <thead>
                <tr>
                    ...
                    <th class="kepala-cetak">Tanggal Verifikasi</th>
                    <th class="kepala-cetak">Status Pelimpahan</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                if (!empty($data_pelimpahan)) {
                    foreach ($data_pelimpahan as $row) {
                        ...
                        echo "<td class='badan-cetak'>" . $status_raw . "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='8' class='badan-cetak'>Tidak ada data berkas pelimpahan jamaah haji yang ditemukan.</td></tr>";
                }
                ?>
            </tbody>
        </table>
