        ...
        <table class="tabel-cetak">
            <thead>
                <tr>
                    ...
                    <th class="kepala-cetak">No. Porsi</th>
                    <th class="kepala-cetak">Nama Jamaah</th>
                    <th class="kepala-cetak">Bin/Binti</th>
                    ...
                    <th class="kepala-cetak">Status Pendaftaran</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                if (!empty($data_pendaftaran)) {
                    foreach ($data_pendaftaran as $row) {
                        ...
                        echo "<td class='badan-cetak'>" . htmlspecialchars($row['nama_ayah']) . "</td>";
