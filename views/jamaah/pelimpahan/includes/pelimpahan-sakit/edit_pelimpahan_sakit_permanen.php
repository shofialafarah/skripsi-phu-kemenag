        ...
        <main class="pPembatalan-wrapper">
            <div class="pPembatalan">
                <div class="pPembatalan-header" style="background-color: #1b5e20; color: white;">
                    Edit Pelimpahan Haji - Sakit Permanen
                </div>
                <div class="pPembatalan-body" style="color: #1b5e20;">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <!-- ================================================================================================= -->
                        <div class="section-title">Edit Berkas Pelimpahan</div>
                        <hr>
                        <div class="row g-3">
                            <!-- Surat Sakit -->
                            <div class="col-md-4">
                        ...
                        <div class="action-buttons">
                            <button type="submit" class="btn btn-success"><i class="fas fa-edit me-1"></i> EDIT DATA PELIMPAHAN</button>
                            <a href="../pelimpahan_jamaah_sakit.php" class="btn btn-secondary">KEMBALI</a>
                        </div>
                    </form>
                </div>
