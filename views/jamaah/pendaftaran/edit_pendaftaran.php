...
<div class="layout">
    ...
    <script src="phu-kemenag-banjar-copy/views/jamaah/pendaftaran/assets/js/tambah_data.js"></script>
    <script src="phu-kemenag-banjar-copy/views/jamaah/pendaftaran/assets/js/tambah_data_ktp.js"></script>
</body>
