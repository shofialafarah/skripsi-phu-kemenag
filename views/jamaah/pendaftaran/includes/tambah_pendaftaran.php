...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // =========================
    function uploadDokumen($fileFieldName, $target_dir, $prefix, $nama_jamaah, $folder_jamaah)
    {
        ...
        return "uploads/pendaftaran/pengajuan-jamaah/" . $folder_jamaah . "/" . $new_file_name;
    }
    ...
    $dokumen_setor_awal = uploadDokumen('dokumen_setor_awal', $target_dir, 'SetorAwal', $nama_jamaah, $folder_jamaah);
    $dokumen_ktp        = uploadDokumen('dokumen_ktp', $target_dir, 'KTP', $nama_jamaah, $folder_jamaah);
    $dokumen_kk         = uploadDokumen('dokumen_kk', $target_dir, 'KK', $nama_jamaah, $folder_jamaah);
    $dokumen_lain       = uploadDokumen('dokumen_lain', $target_dir, 'DokumenLain', $nama_jamaah, $folder_jamaah);
    $foto_wajah         = uploadDokumen('foto_wajah', $target_dir, 'FotoWajah', $nama_jamaah, $folder_jamaah);
