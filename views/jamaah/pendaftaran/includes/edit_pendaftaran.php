...
function uploadDokumen($fileFieldName, $target_dir, $nama_jamaah, $old_file_path = null)
{
    ...
    $clean_name = str_replace(' ', '_', $nama_jamaah);
    $unique_file_name = $fileFieldName . '_' . $clean_name . '.' . $file_ext;
    ...
    // Cek format file
    if (strtolower($fileFieldName) === 'fotowajah' || strtolower($fileFieldName) === 'foto_wajah') {
        if (!in_array($mime, ['image/jpeg', 'image/png'])) {
            die("Error: Foto Wajah harus berupa JPG atau PNG.");
        }
    } else {
        if ($mime !== 'application/pdf') {
            die("Error: File $fileFieldName harus berupa PDF.");
        }
    }
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php endif; ?>
                                <input type="file" name="SetorAwal" class="form-control" accept="application/pdf">
                            </div>
                            <!-- KTP atau KIA -->
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php else: ?>
                                    <small>Belum ada file</small><br>
                                <?php endif; ?>
                                <input type="file" name="KK" class="form-control" accept="application/pdf">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php else: ?>
                                    <small>Belum ada file</small><br>
                                <?php endif; ?>
                                <input type="file" name="DokumenLain" class="form-control" accept="application/pdf">
                            </div>
                            <!-- Foto Wajah -->
                            <div class="col-md-12">
                                ...
                                <?php else: ?>
                                    <small>Belum ada file</small><br>
                                <?php endif; ?>
                                <input type="file" name="FotoWajah" class="form-control" accept="image/jpeg, image/png">
                            </div>
                        </div>
