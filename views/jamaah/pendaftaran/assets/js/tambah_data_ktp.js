...
document.getElementById("ktp_kecamatan").addEventListener("change", function () {
  const selectedKecamatan = this.value;
  const kelurahanSelect = document.getElementById("ktp_kelurahan");

  kelurahanSelect.innerHTML = '<option value="" disabled selected>--- Pilih Kelurahan ---</option>';

  if (selectedKecamatan && kelurahanDataKTP[selectedKecamatan]) {
    kelurahanDataKTP[selectedKecamatan].forEach(function (kelurahan) {
