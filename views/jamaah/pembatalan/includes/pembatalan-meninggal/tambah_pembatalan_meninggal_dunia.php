...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function uploadFile($input_name, $folder_jamaah, $prefix)
    {
        if (isset($_FILES[$input_name]) && $_FILES[$input_name]['error'] === UPLOAD_ERR_OK) {
            ...
            // Path fisik: naik ke root/uploads 
            ...
            // Format: KTP_AhliWaris_Nama-NIK.pdf
    ...
    // Proses Upload Semua Dokumen
    $dokumen_akta_kematian      = uploadFile('dokumen_akta_kematian', $folder_jamaah, 'AktaKematian');
    ...
    $dokumen_ahli_waris         = uploadFile('dokumen_ahli_waris', $folder_jamaah, 'KeteranganAhliWaris');
    $dokumen_surat_kuasa        = uploadFile('dokumen_surat_kuasa', $folder_jamaah, 'SuratKuasa');
    $dokumen_ktp_ahliwaris      = uploadFile('dokumen_ktp_ahliwaris', $folder_jamaah, 'KTP_AhliWaris');
    $dokumen_ktp_penerima_kuasa = uploadFile('dokumen_ktp_penerima_kuasa', $folder_jamaah, 'KTP_PenerimaKuasa');
    $dokumen_kk_penerima_kuasa  = uploadFile('dokumen_kk_penerima_kuasa', $folder_jamaah, 'KK_PenerimaKuasa');
    $dokumen_akta_kelahiran     = uploadFile('dokumen_akta_kelahiran', $folder_jamaah, 'AktaLahir_AhliWaris');
    $dokumen_buku_nikah         = uploadFile('dokumen_buku_nikah', $folder_jamaah, 'BukuNikah');
    $dokumen_rekening_kuasa     = uploadFile('dokumen_rekening_kuasa', $folder_jamaah, 'RekeningKuasa');
    $foto_wajah                 = uploadFile('foto_wajah', $folder_jamaah, 'Foto_PenerimaKuasa');
