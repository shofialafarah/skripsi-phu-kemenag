                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body">
                                    <h6>Total Estimasi</h6>
                                    <h4><?= $total_estimasi_db ?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body">
                                    <h6>Jamaah Tersedia</h6>
                                    <h4><?= $jamaah_tersedia ?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body">
                                    <h6>Persentase</h6>
                                    <h4><?= $total_pendaftaran > 0 ? round(($total_estimasi_db / $total_pendaftaran) * 100, 1) : 0 ?>%</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="dataEstimasi" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">STATUS HAJI</th>
                                    <th class="text-center">TELAH MENUNGGU</th>
                                    <th class="text-center">ESTIMASI KEBERANGKATAN</th>
...
<script src="assets/js/entry_estimasi.js"></script>
</body>
