...
WHERE id_limpah_meninggal = ?";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $_SESSION['success_message'] = "Data pelimpahan meninggal dunia, <b>" . $nama_jamaah . "</b> </br> berhasil diperbarui!";
    ...
    <div class="layout-content">
        ...
        <main class="pelimpahan-wrapper">
            <div class="pelimpahan-container">
                ...
                <form class="form-edit-pelimpahan" action="edit_pelimpahan_meninggal.php" method="POST" id="form-data">
