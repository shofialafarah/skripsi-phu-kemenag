...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $id_limpah_sakit = $_POST['id_limpah_sakit'];
} else {
...
$query = "SELECT ps.*, p.kategori, p.tanggal_validasi
          FROM pelimpahan_sakit ps
          JOIN pelimpahan p ON ps.id_pelimpahan = p.id_pelimpahan
          WHERE ps.id_limpah_sakit = '$id_limpah_sakit'";
...
if (mysqli_num_rows($result) == 0) {
    die("⚠️ Data tidak ditemukan. Pastikan id_limpah_sakit = $id_limpah_sakit ada di tabel dan join cocok.");
}
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE pelimpahan_sakit SET 
    nama_ahliwaris = ?, 
    nama_ayah_ahliwaris = ?,
...
WHERE id_limpah_sakit = ?";
    ...
    if (mysqli_stmt_execute($stmt)) {
        updateAktivitasPengguna($id_staf, 'staf', 'Pelimpahan', 'Menginput data pelimpahan sakit permanen');
        $_SESSION['success_message'] = "Data pelimpahan sakit permanen, <b>" . $nama_jamaah . "</b> </br> berhasil diperbarui!";
    ...
    <div class="layout-content">
        ...
        <main class="pelimpahan-wrapper">
            <div class="pelimpahan-container">
                ...
                <form class="form-edit-pelimpahan" action="edit_pelimpahan_sakit.php" method="POST" id="form-data">
                    <input type="hidden" name="id_limpah_sakit" value="<?php echo htmlspecialchars($data['id_limpah_sakit']); ?>">
                    <p class="judul-form">DATA AHLI WARIS</p>
                    ...
                    <div class="baris-form">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_sakit" class="form-control" value="<?php echo htmlspecialchars($data['tanggal_sakit']); ?>" required>
                        </div>
                        <div class="form-group">
                            <label>Tahun Sakit</label>
                            <input type="text" name="tahun_sakit" class="form-control" value="<?php echo htmlspecialchars($data['tahun_sakit']); ?>" required>
                        </div>
                    </div>
                    <!-- tombol edit data -->
                    <div>
