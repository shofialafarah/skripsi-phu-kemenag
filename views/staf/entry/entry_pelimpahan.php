                                ...
                                if (!empty($data_pelimpahan)) {
                                    foreach ($data_pelimpahan as $row) {
                                        ...
                                        if ($row['kategori'] == 'Meninggal Dunia') {
                                            ...
                                            echo "<a class='btn btn-warning btn-sm' href='includes/pelimpahan/edit_pelimpahan_meninggal.php?id=$id_detail' title='Edit Data Pelimpahan Meninggal Dunia' $disabledAttr><i class='fa-regular fa-pen-to-square'></i></a>";
                                            echo "<a class='btn btn-success btn-sm' href='includes/pelimpahan/cetak_pelimpahan_meninggal.php?id=$id_detail' title='Cetak Data Pelimpahan Meninggal Dunia' $cetakDisabledAttr><i class='fa-solid fa-print'></i></a>";
                                        } elseif ($row['kategori'] == 'Sakit Permanen') {
                                            $id_detail = $row['id_limpah_sakit'];
                                            echo "<a class='btn btn-warning btn-sm' href='includes/pelimpahan/edit_pelimpahan_sakit.php?id=$id_detail' title='Edit Data Pelimpahan Sakit Permanen' $disabledAttr><i class='fa-regular fa-pen-to-square'></i></a>";
                                            echo "<a class='btn btn-success btn-sm' href='includes/pelimpahan/cetak_pelimpahan_sakit.php?id=$id_detail' title='Cetak Data Pelimpahan Sakit Permanen' $cetakDisabledAttr><i class='fa-solid fa-print'></i></a>";
                                        }
...
<script src="assets/js/filterTanggal_pelimpahan.js"></script>
    <script src="tanggal_entry_pelimpahan.js"></script>
