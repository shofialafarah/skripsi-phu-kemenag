                                ...
                                if (!empty($data_pembatalan)) {
                                    foreach ($data_pembatalan as $row) {
                                        ...
                                        if ($row['kategori'] == 'Meninggal Dunia') {
                                            ...
                                            echo "<a class='btn btn-warning btn-sm' href='edit_pembatalan_meninggal.php?id=$id_detail' $disabledAttr><i class='fa-regular fa-pen-to-square'></i></a>";
                                            echo "<a class='btn btn-success btn-sm' href='cetak_pembatalan_meninggal.php?id=$id_detail' $cetakDisabledAttr><i class='fa-solid fa-print'></i></a>";
                                        } elseif ($row['kategori'] == 'Keperluan Ekonomi') {
                                            $id_detail = $row['id_batal_ekonomi'];
                                            echo "<a class='btn btn-warning btn-sm' href='edit_pembatalan_ekonomi.php?id=$id_detail' $disabledAttr><i class='fa-regular fa-pen-to-square'></i></a>";
                                            echo "<a class='btn btn-success btn-sm' href='cetak_pembatalan_ekonomi.php?id=$id_detail' $cetakDisabledAttr><i class='fa-solid fa-print'></i></a>";
                                        }
