...
$id_pelimpahan = $_GET['id_pelimpahan'] ?? $_POST['id_pelimpahan'] ?? null;

if (!$id_pelimpahan) {
    die("ID pelimpahan tidak ditemukan.");
}

// Ambil data lama dari database
$result = $koneksi->query("SELECT * FROM pelimpahan_sakit WHERE id_pelimpahan = $id_pelimpahan AND id_pelimpahan IN (SELECT id_pelimpahan FROM pelimpahan WHERE id_jamaah = $id_jamaah)");
...
function uploadFile($input_name, $folder, $old_path = null)
{
    if (isset($_FILES[$input_name]) && $_FILES[$input_name]['error'] === UPLOAD_ERR_OK) {
        $target_dir = "uploads/pelimpahan/pengajuan/$folder/";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dokumen_surat_sakit = uploadFile('dokumen_surat_sakit', 'akta_kematian', $data['dokumen_surat_sakit']);
    ...
    // Update query
    $stmt = $koneksi->prepare("UPDATE pelimpahan_sakit SET 
        nama_ahliwaris = ?, nama_ayah_ahliwaris = ?, tempat_lahir_ahliwaris = ?, tanggal_lahir_ahliwaris = ?, 
        ...
        kode_pos_ahliwaris = ?, dokumen_surat_sakit = ?, dokumen_setor_awal = ?, 
    ...
    if ($stmt->execute()) {
        ...
        updateAktivitasPengguna($id_jamaah, 'jamaah', 'Pelimpahan', 'Mengedit data pelimpahan sakit permanen');
        $_SESSION['success_message'] = "Data berhasil diubah.";
        header("Location: pelimpahan_jamaah_sakit.php");
        exit();
    } else {
...
<!DOCTYPE html>
<html lang="id_pelimpahan">

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Edit Pelimpahan Jamaah - Sakit Permanen</title>
            ...
            <main class="pPembatalan-wrapper">
                <div class="pPembatalan">
                    <div class="pPembatalan-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-edit me-1"></i> Edit Pelimpahan Haji - Sakit Permanen
                    </div>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="jenis_kelamin_ahliwaris" id_pelimpahan="jenis_kelamin_ahliwaris" class="select-daftar" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="pekerjaan_ahliwaris" id_pelimpahan="pekerjaan_ahliwaris" class="select-daftar" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="bank_ahliwaris" class="form-control" required>
                                        <option value="">-- Pilih Bank Syariah di Kalsel --</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="status_dengan_jamaah" id_pelimpahan="status_dengan_jamaah" class="select-daftar" required>
                            ...
                            <!-- ================================================================================================= -->
                            <div class="section-title">Edit Berkas Pelimpahan - Sakit Permanen</div>
                            <hr>
                            <div class="row g-3">
                                <!-- Surat Sakit -->
                                <div class="col-md-4">
                                    <label class="form-label">Surat Sakit (PDF)</label>
                                    <input type="file" name="dokumen_surat_sakit" class="form-control" accept="application/pdf"
                                    <?php if (empty($data['dokumen_surat_sakit'])) echo 'required'; ?>>
                                    <?php if (!empty($data['dokumen_surat_sakit'])): ?>
                                        <small style="color: #1b5e20;">File saat ini: <a href="<?php echo htmlspecialchars($data['dokumen_surat_sakit']); ?>" target="_blank"><?php echo basename($data['dokumen_surat_sakit']); ?></a></small><br>
                                    <?php else: ?>
                            ...
                            <div class="action-buttons">
                                <button type="submit" class="btn btn-success">EDIT PELIMPAHAN</button>
                                <a href="pelimpahan_jamaah_sakit.php" class="btn btn-secondary">BATAL</a>
                            </div>
                        </form>
                    </div>
