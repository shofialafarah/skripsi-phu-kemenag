...
<body onload="window.print();">
    ...
    <div class="content">
        ...
        <p style="text-align: justify;">Sehubungan dengan hal itu dimohon kiranya Bapak dapat memproses pembatalan sekaligus pengembalian uang setoran awal tabungan BPIH calon jamaah haji tersebut dan sebagai bahan administrasi terlampir disampaikan:</p>
        <ol>
