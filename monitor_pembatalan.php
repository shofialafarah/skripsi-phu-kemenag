...
<div class="container">
    <h2>Monitor Pengajuan Pembatalan Jamaah</h2>

    <!-- Tabel Status Permohonan Pembatalan -->
        ...
        <tbody>
            ...
            while ($row = $result_pembatalan->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td>
                        <a href='#' class='btn btn-success btn-aksi' data-id='{$row['id_pembatalan']}' data-status='Disetujui' data-type='pembatalan'>
                        <i class='fas fa-check-circle'></i></a>
                        <a href='#' class='btn btn-danger btn-aksi' data-id='{$row['id_pembatalan']}' data-status='Ditolak' data-type='pembatalan'>
