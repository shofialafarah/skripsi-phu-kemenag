...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alasan = 'Keperluan Ekonomi'; // Set alasan otomatis menjadi Keperluan Ekonomi
    ...
    $query_pembatalan = "INSERT INTO pembatalan_ekonomi (nama_jamaah, tempat_lahir, tanggal_lahir, alamat, kecamatan, kelurahan, jenis_kelamin, pekerjaan, bps, nomor_rek, bin_binti, nomor_porsi, spph_validasi, alasan, tanggal_surat, tanggal_register, nomor_surat, nominal_setoran, no_telepon)
    VALUES ('$nama_jamaah', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$kecamatan', '$kelurahan', '$jenis_kelamin', '$pekerjaan', '$bps', '$nomor_rek', '$bin_binti', '$nomor_porsi', '$spph_validasi', '$alasan', '$tanggal_surat', '$tanggal_register', '$nomor_surat', '$nominal_setoran', '$no_telepon')";
    ...
    // Debug untuk memastikan data ditangkap
    echo "<pre>";
    print_r($_POST);
    echo "</pre>";
    exit; // Hentikan sementara untuk melihat data
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="background-atas">
        <div class="header">
            <h1>Tambah Pembatalan - Keperluan Ekonomi</h1>
        ...
        <form action="tambah_pembatalan_ekonomi.php" method="POST">
            <p>DATA JAMAAH</p>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>Alasan:</label>
                    <input type="text" name="alasan" value="Keperluan Ekonomi" class="form-control" readonly>
                </div>
                <div class="form-group">
