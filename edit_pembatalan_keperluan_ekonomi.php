...
<head>
    ...
    <title>Edit Pembatalan Jamaah - Keperluan Ekonomi</title>
            ...
            <main class="pPembatalan-wrapper">
                <div class="pPembatalan">
                    <div class="pPembatalan-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-edit me-1"></i> Edit Pembatalan Haji - Keperluan Ekonomi
                    </div>
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <!-- ================================================================================================= -->
                        <div class="section-title">Edit Berkas Pembatalan - Keperluan Ekonomi</div>
                        <hr>
                        <div class="row g-3">
                        ...
                        <div class="action-buttons">
                            ...
                            <a href="pembatalan_jamaah_ekonomi.php" class="btn btn-secondary">BATAL</a>
                        </div>
                    </form>
