...
<head>
    ...
    <title>Sidebar Administrator</title>
                ...
                <div class="content-wrapper">
                    <nav class="menu">
                        ...
                        <div class="submenu <?= in_array($currentPage, $penggunaPages) ? 'open' : '' ?>" id="penggunaSubmenu">
                            <a href="manajemen_jamaah.php" class="<?= ($currentPage == 'manajemen_jamaah.php' || $currentPage == 'tambah_jamaah.php' || $currentPage == 'edit_jamaah.php') ? 'active' : '' ?>">Jamaah</a>
                            <a href="manajemen_staf.php" class="<?= ($currentPage == 'manajemen_staf.php' || $currentPage == 'tambah_staf.php' || $currentPage == 'edit_staf.php') ? 'active' : '' ?>">Staf PHU</a>
                            <a href="manajemen_kasi.php" class="<?= ($currentPage == 'manajemen_kasi.php' || $currentPage == 'tambah_kasi.php' || $currentPage == 'edit_kasi.php') ? 'active' : '' ?>">Kepala Seksi</a>
                        </div>
                        <!-- Manajemen Sistem -->
