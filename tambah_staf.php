    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
            ...
            if (!in_array($file_extension, $allowed_extensions)) {
                ...
                $target_path = 'uploads/staf/' . $new_filename;

                // Pastikan direktori uploads/staf ada
                if (!is_dir('uploads/staf/')) {
                    mkdir('uploads/staf/', 0777, true);
                }

                if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_path)) {
                    $foto = $target_path; // contoh: 'uploads/staf/Staf_budi.png'
                } else {
                            ...
                            <div class="tambah-staf">
                                ...
                                <div style="display: flex; gap: 10px; align-items: center; margin-top: 5px;">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 15px;">
                                        <div>
                                            <img id="previewFoto" src="uploads/staf/profil.jpg"
                                                alt="Foto Staf"
