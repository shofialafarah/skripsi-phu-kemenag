            ...
            <tbody>
                ...
                if (!empty($data_pengguna)) {
                    foreach ($data_pengguna as $row) {
                        ...
                        if (!empty($email)) {
                            echo "<td class='email'><a href='mailto:$email'>$email</a></td>";
                        } else {
                            echo "<td class='email'>-</td>";
                        }
                        echo "<td style='text-align: center;'>" . htmlspecialchars($row['no_telepon']) . "</td>";

                        echo "<td style='text-align: center;'>" . date('d-m-Y', strtotime($row['created_at'])) . "</td>";
                        echo "<td style='text-align: center;'>" . date('d-m-Y', strtotime($row['updated_at'])) . "</td>";
                        echo "<td style='text-align: center;'>" . htmlspecialchars($row['status_pengguna']) . "</td>";
                        echo "</tr>";
                    }
                } else {
