...
<head>
    ...
    <title>Edit Pendaftaran - Halaman Jamaah</title>
...
<body>
        ...
        <div class="layout-content">
            ...
            <main class="pPendaftaran-wrapper">
                <div class="pPendaftaran">
                    <div class="pPendaftaran-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-edit me-1"></i> Edit Pendaftaran Haji
                    </div>
                    <div class="pPendaftaran-body" style="color: #1b5e20;">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="action-buttons">
                                ...
                                <a href="pendaftaran_jamaah.php" class="btn btn-secondary">BATAL</a>
                            </div>
                        </form>
                    </div>
    ...
    <script src="tambah_data_ktp.js"></script>
</body>
