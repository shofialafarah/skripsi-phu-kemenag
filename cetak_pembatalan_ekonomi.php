...
<body>
    ...
    <div class="btn-group">
        ...
        <a href="sptjm_ekonomi.php?id=<?php echo $id_batal_ekonomi; ?>" class="btn" target="_blank">Cetak SPTJM</a>
        
        <!-- Tombol untuk mencetak Permohonan -->
        <a href="surat_permohonan_ekonomi.php?id=<?php echo $id_batal_ekonomi; ?>" class="btn" target="_blank">Cetak Surat Permohonan</a>
        
        <!-- Tombol untuk mencetak Surat Permohonan Pembatalan -->
        <a href="surat_pembatalan_ekonomi.php?id=<?php echo $id_batal_ekonomi; ?>" class="btn" target="_blank">Cetak Surat Pembatalan</a>
    </div>
    <script>
