        ...
        <div class="layout-content">
            ...
            <main class="pPendaftaran-wrapper">
                <div class="pPendaftaran">
                    <div class="pPendaftaran-header" style="background-color: #1b5e20; color: white; margin-bottom:30px;">
                ...
                <?php else: ?>
                    <div class="alert alert-warning text-center">
                        ...
                        <a href="tambah_pendaftaran.php" class="btn btn-primary">Daftar Sekarang</a>
                    </div>
                <?php endif; ?>
