            ...
            <main class="pPembatalan-wrapper">
                <div class="pPembatalan">
                    <div class="pPembatalan-header" style="background-color: #1b5e20; color: white;">
                        <i class="fas fa-plus me-1"></i> Tambah Pembatalan Haji - Meninggal Dunia
                    </div>
                    <div class="pPembatalan-body" style="color: #1b5e20;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <!-- ================================================================================================= -->
                            <div class="section-title">Upload Berkas Pembatalan - Meninngal Dunia</div>
                            <hr>
                            <div class="row g-3">
                                <!-- Akta Kematian -->
                                <div class="col-md-4">
                            ...
                            <div class="action-buttons">
                                ...
                                <a href="tambah_pembatalan.php" class="btn btn-secondary">BATAL</a>
                            </div>
                        </form>
